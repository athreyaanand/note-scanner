package com.athreyaanand.notescanner.views;
...
public class NoteCameraView extends JavaCameraView implements PictureCallback {

    private static final String TAG = "Tutorial3View";
    private String mPictureFileName;

    public NoteCameraView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
