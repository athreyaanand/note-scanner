...
import com.athreyaanand.notescanner.helpers.Quadrilateral;
...
public class ImageProcessor extends Handler {
    ...
    private final NoteScannerActivity mMainActivity;
    ...
    public ImageProcessor ( Looper looper , Handler uiHandler , NoteScannerActivity mainActivity ) {
        super(looper);
    ...
    public void handleMessage ( Message msg ) {
        ...
        if (msg.obj.getClass() == NoteMessage.class) {

            NoteMessage obj = (NoteMessage) msg.obj;
